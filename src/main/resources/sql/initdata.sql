...
VALUES
    ('ACTIVE', 'admin', NOW(), NULL, NULL, 0, 'Philips Air Fryer', 'Oil-free fryer with rapid air technology.', '2025-04-13 12:00:00', '2025-04-27 12:00:00', 'EXCE', 'AVAI', 10, 3, 'https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6369/6369449_rd.jpg', 3, 1, 'OPEN', 250000, NULL, TRUE),
    ('ACTIVE', 'admin', NOW(), NULL, NULL, 0, 'Samsung Front Load Washer', '9kg washing machine with eco-bubble technology.', '2025-04-23 12:00:00','2025-05-28 12:00:00', 'LNEW', 'AVAI', 12, 1, 'https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6323/6323149_sd.jpg', 3, 2, 'OPEN', 7500000, NULL, TRUE),
    ('ACTIVE', 'admin', NOW(), NULL, NULL, 0, 'Dyson Air Purifier', 'Removes 99.97% of allergens and pollutants.', '2025-03-13 12:00:00', '2025-04-29 12:00:00', 'GOOD', 'PEND', 30, 6, 'https://dyson-h.assetsadobe2.com/is/image/content/dam/dyson/leap-petite-global/markets/thai/products/ec/tp07-bn-hepa13-pdp.png', 3, 3, 'OPEN', 4500000, NULL, FALSE),
    ('ACTIVE', 'admin', NOW(), NULL, NULL, 0, 'Sony Bluetooth Speaker', 'Portable speaker with deep bass and 12-hour battery life.', '2025-04-13 12:00:00', '2025-04-30 12:00:00', 'EXCE', 'AVAI', 41, 10, 'https://static.bhphoto.com/images/images500x500/1590584805_1566561.jpg', 4, 5, 'OPEN', 1500000, NULL, TRUE),
    ('ACTIVE', 'admin', NOW(), NULL, NULL, 0, 'Xiaomi Smart LED Bulb', 'Dimmable LED bulb with smart home integration.', '2025-04-03 12:00:00','2025-05-13 12:00:00', 'LNEW', 'NLFE', 46, 4, 'https://www.mistorechile.cl/wp-content/uploads/2024/03/led-bulb-white-and-color-4-0021c55c-7990-4996-8b36-857ca8236398.png', 4, 6, 'OPEN', 200000, NULL, FALSE),
    ('ACTIVE', 'admin', NOW(), NULL, NULL, 0, 'Panasonic Electric Blanket', 'Soft and cozy heated blanket with adjustable temperature.', '2025-04-23 12:00:00', '2025-05-24 12:00:00', 'BNEW', 'AVAI', 59, 7, 'https://panasonicjp.scene7.com/is/image/panasonicjp/DB-RM3M-C?fmt=png-alpha', 5, 7, 'OPEN', 800000, NULL, TRUE),
    ('ACTIVE', 'admin', NOW(), NULL, NULL, 0, 'LG Smart TV 55 Inch', '4K UHD Smart TV with Dolby Vision and AI sound.', '2025-04-03 12:00:00','2025-04-28 12:00:00', 'GOOD', 'AVAI', 35, 2, 'https://www.lg.com/content/dam/channel/wcms/vn/images/tivi/55uq7550psf_atv_eavh_vn_c/gallery/DZ-01.jpg', 5, 8, 'DESI', 12000000, 1, TRUE),
    ('ACTIVE', 'admin', NOW(), NULL, NULL, 0, 'TOTO Smart Toilet Seat', 'Heated seat with bidet and self-cleaning function.', '2025-04-13 12:00:00','2025-04-28 12:00:00', 'FAIR', 'AVAI', 79, 8, 'https://assets.totousa.com/MS922CUMFG/images/MS922CUMFG_01_2000_2000.webp', 6, 9, 'DESI', 5000000, 2, FALSE),
